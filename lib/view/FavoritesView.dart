...
class FavoriteView extends StatefulWidget {
  ...
  final User user;
  const FavoriteView({Key? key, required this.listFavorites, required this.user}) : super(key: key);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          icon: const Icon(Icons.arrow_back, color: kPrimary2Color,),
        ),
        centerTitle: true,
        title: Text("Favoritos", style: GoogleFonts.poppins(color:Colors.black)),
      ),
      body: Padding(
