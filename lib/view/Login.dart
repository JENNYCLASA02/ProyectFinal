import 'package:animal_love/bd/UserManager.dart';
import 'package:animal_love/model/User.dart';
import 'package:animal_love/util/ButtonLogin.dart';
import 'package:animal_love/util/ShowDialog.dart';
                  ...
                  ButtonLogin(
                      press: () async {
                        if (_formKey.currentState!.validate()) {
                          ...
                          if (userLoad != null) {
                            final favorite = Favorite([], userLoad.user);
                            final favoriteAnimals =
                            await favorite.loadFavoriteAnimals(userLoad.user);
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) {
                                  return Home(user: userLoad, listFavorites: favoriteAnimals);
                                },
                              ),
                            );
                          } else {
